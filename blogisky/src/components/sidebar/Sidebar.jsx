  ...
  return (
    <div className='sidebar'>
        <div className="sidebarItem">
            ...
            />
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, repellat illum ipsa ipsum, aliquam sapiente facere et magni possimus a neque explicabo. Ab quasi autem reprehenderit explicabo possimus harum exercitationem?
            </p>
        </div>
        <div className="sidebarItem">
